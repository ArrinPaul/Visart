        ...
        {[
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 pb-3.5 px-3 text-xs sm:text-sm font-semibold tracking-wide border-b-2 transition-all whitespace-nowrap ${
                isActive
              ...
              <div className="flex items-center gap-2">
                {isEditing ? (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-[#54745A] text-white text-xs font-semibold rounded-lg hover:bg-[#435e48] transition-colors"
                  >
            ...
            <div className="p-5 bg-[#FBF8F2] border border-[#D8D0C4] rounded-2xl space-y-2">
              <div className="flex items-center justify-between text-xs font-semibold uppercase tracking-wider text-[#68655F]">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-[11px] text-[#B85C43] hover:underline"
                >
                  {copiedField === 'title' ? (
                    <>
              ...
              {isEditing ? (
                <input
                  ...
                  className="w-full px-3 py-2 bg-white border border-[#D8D0C4] rounded-lg font-serif text-lg text-[#1E211F] focus:outline-none focus:border-[#B85C43]"
                />
              ) : (
                <p className="font-serif text-xl font-medium text-[#1E211F]">
                  {title}
                </p>
              )}
            </div>
            ...
            <div className="p-6 bg-[#FBF8F2] border border-[#D8D0C4] rounded-2xl space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-2">
                <div>
                  ...
                  <div className="font-serif text-4xl sm:text-5xl font-bold text-[#27344A] pt-1">
                ...
                <div className="p-3 bg-[#F5F0E8] border border-[#D8D0C4] rounded-xl text-xs space-y-1">
                  ...
                  <div className="font-serif text-lg font-bold text-[#1E211F]">
            ...
            <div className="p-5 bg-[#FBF8F2] border border-[#D8D0C4] rounded-2xl space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-xs font-semibold text-[#B85C43] hover:underline"
                >
                  {copiedField === 'ig' ? (
                    <>
            ...
            <div className="p-5 bg-[#FBF8F2] border border-[#D8D0C4] rounded-2xl space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-xs font-semibold text-[#54745A] hover:underline"
                >
                  {copiedField === 'wa' ? (
                    <>
                      <Check className="w-3.5 h-3.5 text-[#54745A]" />
            ...
            <div className="p-5 bg-[#FBF8F2] border border-[#D8D0C4] rounded-2xl space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-xs font-semibold text-[#27344A] hover:underline"
                >
                  {copiedField === 'ad' ? (
                    <>
                      <Check className="w-3.5 h-3.5 text-[#54745A]" />
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 bg-[#FBF8F2] border border-[#D8D0C4] rounded-2xl space-y-4">
              <div className="space-y-1">
                ...
                <p className="font-serif text-2xl font-medium text-[#1E211F]">
                  {activeLanguage === 'hi'
